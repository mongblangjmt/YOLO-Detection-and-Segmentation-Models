...
# 실행 파라미터 설정
image_path = r"C:\Introduction to Artificial Intelligence\dlsrhdwlsmdrlakf\Road.jpg"   # 분석할 이미지 경로
output_dir = r"C:\IntroductiontoArtificialIntelligence\dlsrhdwlsmdrlakf\results"  # 결과 저장 디렉토리 (저장 안 함)
